...
describe('modelo financeiro',()=>{
 ...
 it('não trata distribuição de lucros como despesa',()=>{ const r=calculateMonthlyFinance(txs,2026,1); expect(r.receitas).toBe(2000); expect(r.despesas).toBe(500); expect(r.distribuicoes).toBe(300); expect(r.resultado).toBe(1500) })
