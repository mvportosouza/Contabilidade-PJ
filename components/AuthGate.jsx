...
export default function AuthGate({ children }) {
  ...
  if (loading) {
    return <div style={styles.page}><div style={styles.card}><div style={styles.spinner}>⏳</div><h1 style={styles.title}>Finanças PJ</h1><p style={styles.muted}>Verificando sua sessão…</p></div></div>
  }
  ...
  return <><>{children}</><button onClick={signOut} style={styles.signOut} title="Sair da conta">Sair</button></>
}
...
const styles = {
  ...
  spinner: { fontSize: 24 }, title: { margin: '0 0 8px', color: '#0F1E35', fontSize: 27 }, subtitle: { margin: '0 0 22px', color: '#6B655E', lineHeight: 1.5 }, muted: { color: '#6B655E' }, tabs: { display: 'flex', gap: 8, marginBottom: 20 }, tab: { flex: 1, border: '1px solid #E0D8CE', background: '#fff', borderRadius: 10, padding: 10, color: '#777', cursor: 'pointer' }, tabActive: { flex: 1, border: '1px solid #0F1E35', background: '#0F1E35', borderRadius: 10, padding: 10, color: '#fff', cursor: 'pointer' }, label: { display: 'block', margin: '12px 0 6px', color: '#4D473F', fontWeight: 700, fontSize: 13 }, input: { width: '100%', boxSizing: 'border-box', border: '1px solid #D9D2C8', borderRadius: 11, padding: '12px 13px', fontSize: 15, outline: 'none' }, primary: { width: '100%', border: 0, borderRadius: 12, padding: 13, marginTop: 18, background: '#0F1E35', color: '#fff', fontWeight: 800, fontSize: 15, cursor: 'pointer' }, error: { marginTop: 14, padding: 11, borderRadius: 10, background: '#FCEAEA', color: '#9B2525', fontSize: 13, lineHeight: 1.4 }, success: { marginTop: 14, padding: 11, borderRadius: 10, background: '#EAF7EE', color: '#236B3A', fontSize: 13, lineHeight: 1.4 }, note: { margin: '16px 0 0', color: '#8A837A', fontSize: 11, lineHeight: 1.5 }, signOut: { position: 'fixed', top: 12, right: 12, zIndex: 9999, border: '1px solid #D9D2C8', background: '#fff', color: '#555', borderRadius: 10, padding: '7px 11px', cursor: 'pointer', boxShadow: '0 3px 12px rgba(0,0,0,.08)' },
}
